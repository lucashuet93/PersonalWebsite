	...
	if (user === null) {
		...
		return (
			<div className="ms-font-m ms-fontWeight-semilight blogPost">
				...
				<BlogPostSubHeader subHeader="Create Your React Project" />
				...
				<BlogPostSubHeader subHeader="Create an Active Directory v2 App" />
				...
				<BlogPostSubHeader subHeader="Create a Reusable AzureADHelper Class" />
				...
				<BlogPostSubHeader subHeader="Use the AzureADHelper Class in the React Project" />
